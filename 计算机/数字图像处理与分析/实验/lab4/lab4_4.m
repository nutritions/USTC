...
subplot(2,4,2), imshow(pout_ideal, []), title('理想高通滤波器');
subplot(2,4,3), imshow(pout_blpf, []), title('巴特沃斯高通滤波器');
subplot(2,4,4), imshow(pout_gauss, []), title('高斯高通滤波器');
subplot(2,4,5), imshow(girl, []), title('girl原图');
subplot(2,4,6), imshow(girl_ideal, []), title('理想高通滤波器');
subplot(2,4,7), imshow(girl_blpf, []), title('巴特沃斯高通滤波器');
subplot(2,4,8), imshow(girl_gauss, []), title('高斯高通滤波器');
